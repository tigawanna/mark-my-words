...
export function PublishTargetAuthForm({}: PublishTargetAuthFormProps) {
  ...
  return (
    <div className="w-full h-full  flex p-1 flex-col items-center justify-center">
      <div className="w-[98%] p-5 flex items-center justify-center">
